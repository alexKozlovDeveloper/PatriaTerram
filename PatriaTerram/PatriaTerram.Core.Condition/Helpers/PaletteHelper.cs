...
namespace PatriaTerram.Core.Condition.Helpers
{
    ...
    {
        public static Dictionary<int, List<Coord>> GetMaxBuildingConditionCoords(this Palette<ConditionPalettePoint> palette, string townName, BuildingType buildingType, string terrain)
        {
        ...
        public static Coord GetMaxBuildingConditionCoordWithoutBuildings(this Palette<ConditionPalettePoint> palette, string townName, BuildingType buildingType, string terrain)
        {
        ...
        public static void MovePointsXAxis(this Palette<ConditionPalettePoint> palette, int distance)
        {
            for (int y = 0; y < palette.Height; y++)
            {
                var row = new ConditionPalettePoint[palette.Width];
        ...
        public static void MovePointsYAxis(this Palette<ConditionPalettePoint> palette, int distance)
        {
            for (int x = 0; x < palette.Width; x++)
            {
                var column = new ConditionPalettePoint[palette.Height];
        ...
        public static List<string> GetAllTownNames(this Palette<ConditionPalettePoint> palette)
        {
